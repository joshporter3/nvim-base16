...
function M.setup(colors, config)
    ...
    hi.NormalFloat  = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
    hi.FloatBorder  = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
    hi.NormalNC     = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
    ...
    if M.config.telescope then
        if hex_re:match_str(M.colors.base00) and hex_re:match_str(M.colors.base01) and hex_re:match_str(M.colors.base02) then
            ...
            hi.TelescopeBorder        = { guifg = M.colors.base0B, guibg = 'none', gui = nil, guisp = nil }
            hi.TelescopePromptBorder  = { guifg = M.colors.base08, guibg = 'none', gui = nil, guisp = nil }
            hi.TelescopeResultsBorder = { guifg = M.colors.base0D, guibg = 'none', gui = nil, guisp = nil }
            hi.TelescopePromptNormal  = { guifg = M.colors.base05, guibg = 'none', gui = nil, guisp = nil }
            hi.TelescopePromptPrefix  = { guifg = M.colors.base08, guibg = 'none', gui = nil, guisp = nil }
            hi.TelescopeNormal        = { guifg = nil, guibg = 'none', gui = nil, guisp = nil }
            ...
            hi.TelescopeResultsTitle  = { guifg = darkerbg, guibg = M.colors.base0D, gui = nil, guisp = nil }
            hi.TelescopeSelection     = { guifg = M.colors.base07, guibg = nil, gui = nil, guisp = nil }
